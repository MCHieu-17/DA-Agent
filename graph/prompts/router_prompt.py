...
<<<<<<< HEAD:graph/prompts/router_prompt.py
...
2. 'analysis': Yêu cầu phân tích dữ liệu ĐÃ ĐẦY ĐỦ VÀ RÕ RÀNG. Câu hỏi có đủ ngữ cảnh (mục tiêu, đối tượng, khoảng thời gian, bộ lọc) để AI có thể trực tiếp viết Python phân tích ngay.
...
>>>>>>> restore-work:graph/edges/question_router.py
